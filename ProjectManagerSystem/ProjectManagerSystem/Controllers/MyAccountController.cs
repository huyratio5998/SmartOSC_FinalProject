...
namespace ProjectManagerSystem.Controllers
{
    public class MyAccountController : Controller
    {
        ...
        public MyAccountController(IAspNetUserRolesService aspNetUserRolesService,IAspNetRolesRepository aspNetRolesRepository,IAspNetRolesService aspNetRolesService,IUnitOfWork unitOfWork, IMyAccountService myAccountService)
        {
